...
<div class="py-4 bg-dark text-info">
      <div class="row">
        <div class="col-12 col-sm-12 col-md-9 col-lg-9">			
		  <div class="bg-dark-opaque" >				
                <h1>Gestión de la tabla Tienda</h1>
		  </div>
		  <div class="text-center mx-auto col-12">		
            <?php
            
            // Seleccionamos la tabla con la que vamos a trabajar
            $tabla="tienda";// Escribir entre comillas el nombre de la tabla a listar
            ...
            while ($registro = mysqli_fetch_row($resultado)){
				...
				//if (($registro[1]!=$_SESSION['LOGIN']) and ($_SESSION['nivel']==1))	{			
					...
					// Formulario para enviar los datos
						echo '<form name="borraruno" method="POST" action="borrar-tienda.php">';
						echo '<input type="hidden" name="idTienda" value="'.$registro[0].'">';
						echo '<input type="hidden" name="calleTienda" value="'.$registro[1].'">';
				...
				//if (($registro[1]==$_SESSION['LOGIN']) or ($_SESSION['nivel']==1))	{		
					...
					// Formulario para enviar los datos
						echo '<form name="editaruno" method="POST" action="modificar-tienda.php">';
						echo '<input type="hidden" name="id" value="'.$registro[0].'">';
						echo '<input type="hidden" name="calle" value="'.$registro[1].'">';
	  ...
	  <center><a href="crearTienda.php"><h2>Alta tienda</h2></a></center>
    </div>
<?php
