...
<div class="py-4 bg-dark text-info">
      <div class="row">
        <div class="col-12 col-sm-12 col-md-9 col-lg-9">			
		  <div class="bg-dark-opaque" >				
                <h1>Gestión de la tabla Vendedor</h1>
		  </div>
		  <div class="text-center mx-auto col-12">		
            <?php
            
            // Seleccionamos la tabla con la que vamos a trabajar
            $tabla="vendedor";// Escribir entre comillas el nombre de la tabla a listar
            ...
            while ($registro = mysqli_fetch_row($resultado)){
				...
				//if (($registro[1]!=$_SESSION['LOGIN']) and ($_SESSION['nivel']==1))	{			
					...
					// Formulario para enviar los datos
						echo '<form name="borraruno" method="POST" action="borrar-vendedor.php">';
						echo '<input type="hidden" name="nombreVendedor" value="'.$registro[0].'">';
						echo '<input type="hidden" name="idVendedor" value="'.$registro[1].'">';
						echo '<input type="image" src="estilos/Borrar.jpg" title="Borrar ... '.$registro[0].'">';
						echo '</form>';
					//}						
					echo "</td><td align='center'>";	
				//if (($registro[1]==$_SESSION['LOGIN']) or ($_SESSION['nivel']==1))	{		
					...
					// Formulario para enviar los datos
						echo '<form name="editaruno" method="POST" action="modificar-vendedor.php">';
						echo '<input type="hidden" name="nombre" value="'.$registro[0].'">';
						echo '<input type="hidden" name="id" value="'.$registro[1].'">';
						echo '<input type="image" src="estilos/Editar.jpg" title="Cambiar datos de... '.$registro[0].'">';
						echo '</form>';	
					//}
	  ...
	  <!--<center><a href="crearVendedor.php"><h2>Alta vendedor</h2></a></center>-->
    </div>
<?php
