      ...
      <div class="row">
        <div class="col-12 col-sm-12 col-md-9 col-lg-9">			
		  <div class="bg-dark-opaque" >				
                <h1>Gestión de la tabla Producto</h1>
		  </div>
		  <div class="text-center mx-auto col-12">		
            ...
            while ($registro = mysqli_fetch_row($resultado)){
				...
				//if (($registro[1]!=$_SESSION['LOGIN']) and ($_SESSION['nivel']==1))	{			
					...
					// Formulario para enviar los datos
						echo '<form name="borraruno" method="POST" action="borrar-producto.php">';
						echo '<input type="hidden" name="nombreProd" value="'.$registro[0].'">';
						echo '<input type="hidden" name="idProd" value="'.$registro[1].'">';
				...
				//if (($registro[1]==$_SESSION['LOGIN']) or ($_SESSION['nivel']==1))	{		
					...
					// Formulario para enviar los datos
						echo '<form name="editaruno" method="POST" action="modificar-producto.php">';
						echo '<input type="hidden" name="nombreProd" value="'.$registro[0].'">';
						echo '<input type="hidden" name="idProd" value="'.$registro[1].'">';
		...
		<center><a href="crearProducto.php"><h2>Alta producto</h2></a></center>
    </div>
<?php
