      ...
      <div class="row">
        <div class="col-12 col-sm-12 col-md-9 col-lg-9">			
		  <div class="bg-dark-opaque" >				
                <h1>Gestión de la tabla Usuario</h1>
		  </div>
		  <div class="text-center mx-auto col-12">		
            <?php
            
            // Seleccionamos la tabla con la que vamos a trabajar
            $tabla="usuario";// Escribir entre comillas el nombre de la tabla a listar
            ...
            while ($registro = mysqli_fetch_row($resultado)){
				...
				//if (($registro[1]!=$_SESSION['LOGIN']) and ($_SESSION['nivel']==1))	{			
					...
					// Formulario para enviar los datos
						...
						echo '<input type="hidden" name="idUsu" value="'.$registro[0].'">';
						echo '<input type="hidden" name="llave" value="'.$registro[1].'">';
